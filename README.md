...
| <img src="https://flagcdn.com/w20/us.png" alt="EN"/> | <img src="https://flagcdn.com/w20/br.png" alt="PT-BR"/> |
|----------------------------------------------------|--------------------------------------------------------|
| I’m **Luther Marques Cordeiro**, a **Software Engineer** focused on building **scalable platforms, distributed systems, and real-time streaming solutions**.<br><br>I work primarily with the **JavaScript/TypeScript ecosystem**, but my experience goes beyond frameworks — I design **end-to-end architectures**, from frontend UX to backend services, P2P delivery, media pipelines, and global payment flows. | Sou **Luther Marques Cordeiro**, **Engenheiro de Software**, com foco na construção de **plataformas escaláveis, sistemas distribuídos e soluções de streaming em tempo real**.<br><br>Atuo principalmente com o ecossistema **JavaScript/TypeScript**, indo além de frameworks, projetando **arquiteturas ponta a ponta**, do frontend ao backend, incluindo distribuição P2P, pipelines de mídia e fluxos globais de pagamento. |
